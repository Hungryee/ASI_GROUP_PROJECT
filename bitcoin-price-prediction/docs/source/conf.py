...
# bitcoin_price_prediction documentation build
...
from bitcoin_price_prediction import __version__ as release

# -- Project information -----------------------------------------------------

project = "bitcoin_price_prediction"
author = "Kedro"
...
texinfo_documents = [
    (
        ...
        author,
        "bitcoin_price_prediction",
        "Project bitcoin_price_prediction codebase.",
        "Data-Science",
    )
]
